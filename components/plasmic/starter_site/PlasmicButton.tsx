...
// Plasmic Project: qbBcMg6BfjSWF77FaGfEsJ
// Component: ovgR1KT3Aa-u
...
import projectcss from "./plasmic.module.css"; // plasmic-import: qbBcMg6BfjSWF77FaGfEsJ/projectcss
import sty from "./PlasmicButton.module.css"; // plasmic-import: ovgR1KT3Aa-u/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: JkXTvkzQ0-Ao/icon
import ChevronDown2Icon from "./icons/PlasmicIcon__ChevronDown2"; // plasmic-import: RWgz5ycsqV7r/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__zSsBi, {
          [sty.freeBoxcolor_neutral__zSsBIbdxZ]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__zSsBie7UJGKgK]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxcolor_white__zSsBimz1X]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__zSsBi6LdaV]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__zSsBiBk71]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__zSsBinp12N]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__zSsBIlNrQw]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__zSsBiAoGdx]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__zSsBIgKgK]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__woiN, {
            [sty.freeBoxcolor_neutral__woiNbdxZ]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__woiNbdxZXpgPx]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__woiNYjazo]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__woiNBk71]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__woiNlNrQw]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__woiNAoGdx]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__woiNgKgK]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__tLa7)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__b3F5I, {
            [sty.freeBoxiconEnd__b3F5IFxyv5]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__b3F5IBk71]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__b3F5IlNrQw]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__b3F5IAoGdx]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg__agw2O)}
                role={"img"}
              />
            ),
